...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>KF</b>GF</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>KF</b>GF</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Välkommen till KFGFs admin panel!
        <small>Här kan du lägga till eller ta bort medlemmar, du kan även få information om nuvarande medlemmar!</small>
      </h1>
    </section>
  </div>
  <!-- /.content-wrapper -->
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Gjort av Alexander Svensson, Ekasit Banditsunthorn och Hampus Hall
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">Alexander, Ekasit och Hampus</a>.</strong> All rights reserved.
  </footer>
